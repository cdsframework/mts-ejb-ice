...
INSERT INTO system_property (property_id, name, type, property_group, scope, value, obscure, mts_only, last_mod_datetime, last_mod_id, create_datetime, create_id) 
    VALUES ('47e353c5d84e9bc6150bf9fb64f93667', 'ICE_DEFAULT_BUSINESS_ID', 'java.lang.String', NULL, 'ice', 'ICE', 'N', 'N', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP, 'admin');
INSERT INTO system_property (property_id, name, type, property_group, scope, value, obscure, mts_only, last_mod_datetime, last_mod_id, create_datetime, create_id) 
    VALUES ('23fab00c9c8a58c457d56cd734155ec5', 'ICE_DEFAULT_SCOPING_ENTITY_ID', 'java.lang.String', NULL, 'ice', 'org.nyc.cir', 'N', 'N', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP, 'admin');
INSERT INTO system_property (property_id, name, type, property_group, scope, value, obscure, mts_only, last_mod_datetime, last_mod_id, create_datetime, create_id) 
    VALUES ('7d6ca07836d969b539d0625cea909806', 'ICE_DEFAULT_VERSION', 'java.lang.String', NULL, 'ice', '1.0.0', 'N', 'N', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP, 'admin');
INSERT INTO system_property (property_id, name, type, property_group, scope, value, obscure, mts_only, last_mod_datetime, last_mod_id, create_datetime, create_id) 
    VALUES ('2ee7fe4375b628dc45169223db94d249', 'ICE_DEFAULT_CONCEPT_DETERMINATION_METHOD', 'java.lang.String', NULL, 'ice', 'C36', 'N', 'N', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP, 'admin');
INSERT INTO system_property (property_id, name, type, property_group, scope, value, obscure, mts_only, last_mod_datetime, last_mod_id, create_datetime, create_id) 
    VALUES ('73c67099a607a7f8048501735667c1fa', 'TEST_MGR_TEST_SUBMISSION_Q_SIZE', 'java.lang.Integer', 'TEST_MGR', 'ice', '10', 'N', 'N', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP, 'admin');
