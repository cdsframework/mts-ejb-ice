...
alter table ice_series_dose_vaccine_rel drop constraint fk_isdvrvid2cvvid;
...
alter table ice_series_dose_interval drop constraint fk_isdi_fdid2did;
...
alter table ice_series_dose_interval drop constraint fk_isdi_tdid2did;
