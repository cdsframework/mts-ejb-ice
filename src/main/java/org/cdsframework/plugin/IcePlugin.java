...
@Startup
@Singleton
public class IcePlugin extends BasePlugin {

    @Override
    protected void postProcess() throws MtsException {
        initializeDbTables(IceVaccineGroupDTO.class);
        initializeDbTables(IceVaccineDTO.class);
        initializeDbTables(IceSeasonDTO.class);
    }
