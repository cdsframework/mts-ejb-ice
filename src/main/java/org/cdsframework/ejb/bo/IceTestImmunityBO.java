 ...
 */
@Stateless
public class IceTestImmunityBO extends BaseBO<IceTestImmunityDTO> {

    @EJB
    private IceTestBO iceTestBO;

    @Override
    protected void validateAddOrUpdate(IceTestImmunityDTO baseDTO, Operation operation, Class queryClass, List<Class> validationClasses, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
     ...
     */
    private void updateParentsLastModDatetime(IceTestImmunityDTO baseDTO, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
     ...
     */
    @Override
    protected void processEnd(IceTestImmunityDTO baseDTO, List<Class> childClassDTOs, Operation operation, Class queryClass, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
