 ...
 */
@Stateless
public class IceTestProposalBO extends BaseBO<IceTestProposalDTO> {
     ...
     */
    private void updateParentsLastModDatetime(IceTestProposalDTO baseDTO, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
     ...
     */
    @Override
    protected void processEnd(IceTestProposalDTO baseDTO, List<Class> childClassDTOs, Operation operation, Class queryClass, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
