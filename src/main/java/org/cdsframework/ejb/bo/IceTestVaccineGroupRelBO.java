 ...
 */
@Stateless
public class IceTestVaccineGroupRelBO extends BaseBO<IceTestVaccineGroupRelDTO> {
     ...
     */
    private void updateParentsLastModDatetime(IceTestVaccineGroupRelDTO baseDTO, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
     ...
     */
    @Override
    protected void processEnd(IceTestVaccineGroupRelDTO baseDTO, List<Class> childClassDTOs, Operation operation, Class queryClass, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
